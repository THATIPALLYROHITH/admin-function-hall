...
const TAB_TITLES = {
  ...
  accounts: { title: 'Accounts & Finance', subtitle: 'Live revenue, operational expenses, net profit, and reports' },
  receivables: { title: 'Receivables Management', subtitle: 'Track and settle outstanding customer booking balances' },
  'financial-reports': { title: 'Financial Reports & Insights', subtitle: 'Strategic revenue breakdowns, monthly trends, and performance metrics' },
